            ...
            <div class="wrap-address-billing">
                ...
                <form action="{{URL::to('/save-checkout-customer')}}" method="POST" name="frm-billing">
                    ...
                    <p class="row-in-form">
                        ...
                        <input id="fname" type="text" name="shipping_name" value="" placeholder="Your name">
                    </p>
...
{{--                    </p>--}}
                    ...
                    <p class="row-in-form">
                        <label for="city">Ghi chú *<span>*</span></label>
                        <textarea id="city" rows="10" cols="100" type="text" name="shipping_note" value="" placeholder="Ghi chú"></textarea>
                    </p>
...
{{--                        </label>--}}
                        <input type="submit"  class="btn btn-medium"  style="padding: 10px; width: 100px;" value="Gửi">
