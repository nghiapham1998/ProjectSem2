                ...
                <table class="table table-striped b-t b-light">
                    ...
                    @foreach($all_product as $key => $value)
                        <tr>
                            ...
                            <td><img src="public/upload/product/{{$value->product_image}}" height="100" width="150"></td>
                           ...
                           <a href= "{{URL::to('/un_active-product/'.$value->product_id)}}"><span class="fa-thumb-styling fa fa-thumbs-down" style="font-size: 28px; color: red;"></span></a>
                            ...
                            <td>
                                ...
                                <a onclick="return confirm('Bạn có muốn xóa không ?')" href="{{URL::to('/delete-Product/'.$value->product_id)}}" class="active" ui-toggle-class="">
