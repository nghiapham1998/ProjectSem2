                    ...
                    @foreach($all_brand as $key => $value)
                        <tr>
                           ...
                           <a href= "{{URL::to('/un_active-brand/'.$value->brand_id)}}"><span class="fa-thumb-styling fa fa-thumbs-down" style="font-size: 28px; color: red;"></span></a>
                            ...
                            <td>
                                <a href="{{URL::to('/edit-brand/'.$value->brand_id)}}" class="active" ui-toggle-class="">
                                    <i class="fa fa-pencil-square text-success text-active">
                                    </i></a>
                                <a onclick="return confirm('Bạn có muốn xóa không ?')" href="{{URL::to('/delete-brand/'.$value->brand_id)}}" class="active" ui-toggle-class="">
